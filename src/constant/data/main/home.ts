...
export const Features: FeaturesTypes[] = [
  {
    ...
    description:
      "Customize onboarding tasks and checklists tailored to individual roles and departments for a seamless experience",
    bg: "#FEF1E1",
    color: "#D97706",
  },
  {
    ...
    description:
      "Ensure the safety of sensitive personal information with end-to-end encryption and secure authentication methods like OTP.",
    bg: "#DCFEF3",
    color: "#059669",
  },
  {
    ...
    description:
      "Stay on top of every deadline with smart notifications that ensure tasks and document submissions are never missed",
    bg: "#E0EDFF",
    color: "#0041A3",
  },
];
